...
function registerHotKeys(app) {
    app.get('/api/getHotKeys', (req, res) => {
        ...
        const url = 'http://mobilecdn.kugou.com/api/v3/search/hot'
        get(url, {
            g_tk_new_20200303: token
        }).then((response) => {
            const data = response.data
...
function registerSearch(app) {
    app.get('/api/search', (req, res) => {
       ...
       const options = {
            url: 'https://u.y.qq.com/cgi-bin/musicu.fcg?_webcgikey=DoSearchForQQMusicDesktop&_=1681566820433',
            data: data,
            "method": "POST",
            headers:  {
              ...
              "cookie": "pgv_pvid=2321713775; tvfe_boss_uuid=564e0b410b3ef7b0; RK=rhocIeV/Wp; ptcz=2001d4aff98b1aa84550087c1899efd0373c82e5d361ce8ad654f3cb8b708a6d; fqm_pvqid=096b4411-a1e0-4fa0-9760-7feae84bfafc; AMCV_248F210755B762187F000101%40AdobeOrg=-1712354808%7CMCIDTS%7C18797%7CMCMID%7C40032332202711280241940600413160095627%7CMCAAMLH-1624608342%7C11%7CMCAAMB-1624608342%7CRKhpRz8krg2tLO6pguXWp5olkAcUniQYPHaMWWgdJ3xzPWQmdj0y%7CMCOPTOUT-1624010742s%7CNONE%7CMCAID%7CNONE%7CvVersion%7C4.3.0; iip=0; pac_uid=1_1531610513; o_cookie=2064825358; ied_qq=o2064825358; ts_uid=6922012623; qm_keyst=Q_H_L_5Il7_mvAVfQOY5RdPeouhsUuHaVrqBmZgUK43QEvV_JnmvgpeePHKvA; wxopenid=; psrf_musickey_createtime=1681542461; wxrefresh_token=; psrf_qqunionid=FF8A59EBF8792D6C55844C593F5B2DE9; tmeLoginType=2; euin=owns7ecA7KokNn**; wxunionid=; qqmusic_key=Q_H_L_5Il7_mvAVfQOY5RdPeouhsUuHaVrqBmZgUK43QEvV_JnmvgpeePHKvA; psrf_access_token_expiresAt=1689318461; psrf_qqrefresh_token=CFA156B6F93827921DD81D0492044B0D; psrf_qqopenid=AB00B4467045FB6904D8AA192C170EFC; qm_keyst=Q_H_L_5Il7_mvAVfQOY5RdPeouhsUuHaVrqBmZgUK43QEvV_JnmvgpeePHKvA; psrf_qqaccess_token=19A74B30DF93D2640A873B63E1D4D51F; uin=2064825358; fqm_sessionid=a2ced065-e2cf-4c86-9603-068a1b49e6b8; pgv_info=ssid=s7496710650; ts_refer=www.google.com/; ts_last=y.qq.com/n/ryqq/search",
        ...
        axios(options).then(response => {
            ...
            if (data.code === ERR_OK) {
                ...
                const { ein, curpage, sum } = meta
                const hasMore = 20 * (curpage - 1) + ein < sum
